...
namespace HotelManagement.UI
{
    public class exportExcel
    {
        ...
        public async Task exportRevenue(string staffName, RevenueType revenueType, List<string> listDate,
            List<double> listRoomRevenue, List<double> listEatServiceRevenue, List<double> listLaudryServiceRevenue)
        {
            try
            {
