...
namespace HotelManagement.UI
{
    ...
    {
        public static void SetRoomType(RoomType type, MetroRadioButton normalButton,
            MetroRadioButton VIPButton, MetroRadioButton singleButton, MetroRadioButton doubleButton)
        {
        ...
        public static void SetSex(Sex sex, MetroRadioButton male, MetroRadioButton female)
        {
